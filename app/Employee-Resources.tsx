        ...
        <View style={styles.cardContent}>
          ...
          <View style={styles.resourceDetails}>
            ...
            >
              ...
              <Text style={[styles.quickAddText, { color: colors.primary }]}>Add Stock</Text>
            </TouchableOpacity>
          </View>
        </View>
      </TouchableOpacity>
  ...
  const renderRequestItem = ({ item }: { item: ResourceRequest }) => (
    ...
    >
      ...
      <View style={styles.requestContent}>
        ...
        <Text style={[styles.requestContact, { color: colors.textSecondary }]}>
        ...
        <View style={styles.headerContent}>
          <View>
            ...
            <Text style={[styles.headerSubtitle, { color: colors.textSecondary }]}>
              {adminCity} • {resources.length} Resources • {requests.filter(r => r.status === 'pending').length} Pending
            </Text>
          </View>
          <TouchableOpacity 
